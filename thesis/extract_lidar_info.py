...
filename = os.path.join(dirname, 'lidar_tiles_info/*.txt')
...
output_file = os.path.join(dirname, 'extracted_info/lidar_info_extracted.csv')
lidar_info.to_csv(output_file)